...
log("Number of layers " + getNumberOfLayers());
log("Background layers " + getBackgroundLayerCounter());
...
function getDocumentPropertyDescriptor(property) {
    log("getDocumentPropertyDescriptor");
...
var getLayerNames = function() {
    ...
    for (var i = count; i >= 1; i--) {
      ...
      layer.layerId = desc.getString(stringIDToTypeID("layerID"));
